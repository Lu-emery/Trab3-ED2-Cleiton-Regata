...
// TABELA DE SÍMBOLOS
  ...
  // Cria um índice para inserção de um nó a partir de uma chave
  ...
  void preencheTabela(int, Key, unsigned char*);
  ...
  void weakComTabela(Key, int, Key);
